class SETTINGSS():
    def __init__(self) -> None:
        ...
        # /////////////////////////////////// ДРУГОЕ:
        self.minute_counter_limit = 30 # если в течение указанного времени (в минутах) не происходит никакого движениe, то все открытые позиции закрываются, сессия переходит на следующую итерацию