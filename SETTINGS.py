class SETTINGSS():
    def __init__(self) -> None:
        ...
        self.sl_1_pos_rate, self.tp_1_pos_rate = 4, 1 # % -- стоп лосс и тейк профит для 1 позиции в процентах
        self.risk_reward_ratio = '1:1'  # соотношение риска к прибыли sl/tp для первой позиции.
        # /////////////////////////////////// ДРУГОЕ:
        self.minute_counter_limit = None # если в течение указанного времени (в минутах) не происходит никакого движения, то все открытые позиции закрываются, сессия переходит на следующую итерацию. Отключить -- None