...
class RULESS(VARIABLES):
    ...
    def close_1_pos_conditiond(self, symbol_item):
        is_close_1_pos = False
        try:
            if symbol_item["in_position_1"] and not symbol_item["in_position_2"]:
                sl_condition = False
                tp_condition = False
                signal, cur_price = symbol_item["signal"], symbol_item["cur_price"]
        ...
        return symbol_item, is_close_1_pos
